...
pub fn authorize<'info>(
    ...
    mainstay_lang::solana_program::program::invoke_signed(&ix, &account_infos, ctx.signer_seeds)
        .map_err(Into::into)
}
...
impl mainstay_lang::AccountDeserialize for StakeAccount {
...
impl mainstay_lang::AccountSerialize for StakeAccount {}

impl mainstay_lang::Owner for StakeAccount {
    fn owner() -> Pubkey {
        ID
    }
}
...
impl mainstay_lang::Id for Stake {
    fn id() -> Pubkey {
        ID
    }
}
