use mainstay_lang::context::CpiContext;
use mainstay_lang::error::ErrorCode;
...
use mainstay_lang::{system_program, Accounts, Result, ToAccountInfos};
use std::ops::Deref;
...
impl mainstay_lang::AccountDeserialize for MetadataAccount {
...
impl mainstay_lang::AccountSerialize for MetadataAccount {}

impl mainstay_lang::Owner for MetadataAccount {
    fn owner() -> Pubkey {
        ID
    }
}
...
impl mainstay_lang::AccountDeserialize for MasterEditionAccount {
    fn try_deserialize(buf: &mut &[u8]) -> mainstay_lang::Result<Self> {
...
impl mainstay_lang::AccountSerialize for MasterEditionAccount {}

impl mainstay_lang::Owner for MasterEditionAccount {
    fn owner() -> Pubkey {
        ID
    }
}
...
impl mainstay_lang::AccountDeserialize for TokenRecordAccount {
    fn try_deserialize(buf: &mut &[u8]) -> mainstay_lang::Result<Self> {
...
impl mainstay_lang::AccountSerialize for TokenRecordAccount {}

impl mainstay_lang::Owner for TokenRecordAccount {
    fn owner() -> Pubkey {
        ID
    }
}
...
impl mainstay_lang::Id for Metadata {
    fn id() -> Pubkey {
        ID
    }
}
