...
# The mainstay cli must be installed.
#
# cargo install --git https://github.com/nxpkg/mainstay mainstay-cli --locked
#
################################################################################
...
main() {
    ...
    cd ../../tests/composite && mainstay build && cd -
    [ $? -ne 0 ] && exit 1
    cd ../../examples/tutorial/basic-2 && mainstay build && cd -
    [ $? -ne 0 ] && exit 1
    cd ../../examples/tutorial/basic-4 && mainstay build && cd -
    [ $? -ne 0 ] && exit 1
    cd ../../tests/events && mainstay build && cd -
    [ $? -ne 0 ] && exit 1
    cd ../../tests/optional && mainstay build && cd -
    [ $? -ne 0 ] && exit 1
