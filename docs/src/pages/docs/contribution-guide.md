...
description: Mainstay - Contribution Guide
---

Thank you for your interest in contributing to Mainstay! All contributions are welcome no
...
check out [good first issues](https://github.com/nxpkg/mainstay/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
or issues where [help is wanted](https://github.com/nxpkg/mainstay/issues?q=is%3Aissue+is%3Aopen+label%3A%22help+wanted%22).
...
- If you made a change to mainstay's periphery (avm or cli), make a PR to the `mainstay-book` repo if necessary
