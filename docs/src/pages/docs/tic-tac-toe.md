...
> [Mainstay Space Reference](./space)
...
Finally, we verify the game has been set up properly by comparing the actual state and the expected state. To learn how Mainstay maps the Rust types to the js/ts types, check out the [Javascript Mainstay Types Reference](./javascript-mainstay-types).
