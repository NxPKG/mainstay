...
const navigation = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: 'Mainstay.toml', href: '/docs/manifest' },
      { title: 'CLI', href: '/docs/cli' },
      { title: 'AVM', href: '/docs/avm' },
      {
        title: 'Core Library',
        href: 'https://docs.rs/mainstay-lang/latest/mainstay_lang/',
      },
      {
        title: 'Rust Client Library',
        href: 'https://docs.rs/mainstay-client/latest/mainstay_client/',
      },
      // {
      //   title: 'TypeScript Client Library',
      //   href: 'https://docs.rs/mainstay-lang/latest/mainstay_lang/error/enum.ErrorCode.html',
      // },
      {
        title: 'JavaScript Mainstay Types',
        href: '/docs/javascript-mainstay-types',
      },
...
export default function App({ Component, pageProps }) {
  ...
  return (
    <>
      <PlausibleProvider domain="mainstay-lang.com" trackOutboundLinks={true}>
        <Head>
          ...
          <meta
            property="og:image"
            content="https://www.mainstay-lang.com/logo.png"
          />
