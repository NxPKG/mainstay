...
import { MainstayError, type Program } from "@nx-pkg/mainstay";
...
describe('tic-tac-toe', () => {
  ...
  const program = mainstay.workspace.TicTacToe as Program<TicTacToe>;
  const programProvider = program.provider as mainstay.MainstayProvider;
