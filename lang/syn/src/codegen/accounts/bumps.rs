...
pub fn generate_bumps_name<T: Display>(mainstay_ident: &T) -> Ident {
    Ident::new(&format!("{}Bumps", mainstay_ident), Span::call_site())
}
...
pub fn generate(accs: &AccountsStruct) -> proc_macro2::TokenStream {
    ...
    quote! {
        ...
        impl<#combined_generics> mainstay_lang::Bumps for #name<#struct_generics> #where_clause {
