...
pub fn generate(accs: &AccountsStruct) -> proc_macro2::TokenStream {
    ...
    quote! {
        ...
        impl<#combined_generics> mainstay_lang::ToAccountInfos<#trait_generics> for #name <#struct_generics> #where_clause{
            fn to_account_infos(&self) -> Vec<mainstay_lang::solana_program::account_info::AccountInfo<#trait_generics>> {
