...
pub fn generate(f: &Field, accs: &AccountsStruct) -> proc_macro2::TokenStream {
    ...
    let rent = constraints
        ...
        .then(|| quote! { let __mainstay_rent = Rent::get()?; })
    ...
    quote! {
        let #field: #ty_decl = {
            ...
            if __discriminator != 0 {
                return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintZero).with_account_name(#name_str));
            }
            #from_account_info
        };
    }
    ...
    quote! {
        {
            ...
            if #field.key() == #target.key() {
                return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintClose).with_account_name(#name_str));
            }
        }
    }
}
...
pub fn generate_constraint_rent_exempt(
    ...
    match c {
        ...
        ConstraintRentExempt::Enforce => quote! {
            if !__mainstay_rent.is_exempt(#info.lamports(), #info.try_data_len()?) {
                return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintRentExempt).with_account_name(#name_str));
            }
        },
    }
}
...
fn generate_constraint_realloc(
    ...
    quote! {
        ...
        if __reallocs.contains(&#field.key()) {
            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::AccountDuplicateReallocs).with_account_name(#account_name));
        }

        let __mainstay_rent = mainstay_lang::prelude::Rent::get()?;
        let __field_info = #field.to_account_info();
        let __new_rent_minimum = __mainstay_rent.minimum_balance(#new_space);
        ...
        if __delta_space != 0 {
            ...
            if __delta_space > 0 {
                ...
                if ::std::convert::TryInto::<usize>::try_into(__delta_space).unwrap() > mainstay_lang::solana_program::entrypoint::MAX_PERMITTED_DATA_INCREASE {
                    return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::AccountReallocExceedsLimit).with_account_name(#account_name));
                }

                if __new_rent_minimum > __field_info.lamports() {
                    mainstay_lang::system_program::transfer(
                        mainstay_lang::context::CpiContext::new(
                ...
                if c.bump.is_some() {
                    ...
                    quote! {
                        if #field.key() != __pda_address {
                            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintSeeds).with_account_name(#name_str).with_pubkeys((#field.key(), __pda_address)));
                        }
                        if __bump != #b {
                            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintSeeds).with_account_name(#name_str).with_values((__bump, #b)));
                        }
                    }
                } else {
    ...
    match &c.kind {
        InitKind::Token {
            ...
            quote! {
                ...
                let #field: #ty_decl = {
                    ...
                    if !#if_needed || owner_program == &mainstay_lang::solana_program::system_program::ID {
                        #payer_optional_check
                        ...
                        let accounts = ::mainstay_spl::token_interface::InitializeAccount3 {
                            account: #field.to_account_info(),
                            mint: #mint.to_account_info(),
                            authority: #owner.to_account_info(),
                        };
                        let cpi_ctx = mainstay_lang::context::CpiContext::new(cpi_program, accounts);
                        ::mainstay_spl::token_interface::initialize_account3(cpi_ctx)?;
                    }

                    let pa: #ty_decl = #from_account_info_unchecked;
                    if #if_needed {
                        if pa.mint != #mint.key() {
                            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintTokenMint).with_account_name(#name_str).with_pubkeys((pa.mint, #mint.key())));
                        }
                        if pa.owner != #owner.key() {
                            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintTokenOwner).with_account_name(#name_str).with_pubkeys((pa.owner, #owner.key())));
                        }
                        if owner_program != &#token_program.key() {
                            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintTokenTokenProgram).with_account_name(#name_str).with_pubkeys((*owner_program, #token_program.key())));
                        }
                    }
                    pa
                };
            ...
            quote! {
                ...
                let #field: #ty_decl = {
                    ...
                    if !#if_needed || owner_program == &mainstay_lang::solana_program::system_program::ID {
                        ...
                        let cpi_accounts = ::mainstay_spl::associated_token::Create {
                        ...
                        let cpi_ctx = mainstay_lang::context::CpiContext::new(cpi_program, cpi_accounts);
                        ::mainstay_spl::associated_token::create(cpi_ctx)?;
                    }
                    let pa: #ty_decl = #from_account_info_unchecked;
                    if #if_needed {
                        if pa.mint != #mint.key() {
                        ...
                        if owner_program != &#token_program.key() {
                            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintAssociatedTokenTokenProgram).with_account_name(#name_str).with_pubkeys((*owner_program, #token_program.key())));
                        }

                        if pa.key() != ::mainstay_spl::associated_token::get_associated_token_address_with_program_id(&#owner.key(), &#mint.key(), &#token_program.key()) {
                            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::AccountNotAssociatedTokenAccount).with_account_name(#name_str));
                        }
                    }
                    pa
                };
        ...
        InitKind::Mint {
            ...
            if group_pointer_authority.is_some() || group_pointer_group_address.is_some() {
                extensions.push(quote! {::mainstay_spl::token_interface::spl_token_2022::extension::ExtensionType::GroupPointer});
            }

            if group_member_pointer_authority.is_some()
                || group_member_pointer_member_address.is_some()
            {
                extensions.push(quote! {::mainstay_spl::token_interface::spl_token_2022::extension::ExtensionType::GroupMemberPointer});
            }

            if metadata_pointer_authority.is_some() || metadata_pointer_metadata_address.is_some() {
                extensions.push(quote! {::mainstay_spl::token_interface::spl_token_2022::extension::ExtensionType::MetadataPointer});
            }

            if close_authority.is_some() {
                extensions.push(quote! {::mainstay_spl::token_interface::spl_token_2022::extension::ExtensionType::MintCloseAuthority});
            }

            if transfer_hook_authority.is_some() || transfer_hook_program_id.is_some() {
                extensions.push(quote! {::mainstay_spl::token_interface::spl_token_2022::extension::ExtensionType::TransferHook});
            }

            if permanent_delegate.is_some() {
                extensions.push(quote! {::mainstay_spl::token_interface::spl_token_2022::extension::ExtensionType::PermanentDelegate});
            }

            let mint_space = if extensions.is_empty() {
                quote! { ::mainstay_spl::token::Mint::LEN }
            } else {
                quote! { ::mainstay_spl::token_interface::find_mint_account_size(Some(&vec![#(#extensions),*]))? }
            };

            let extensions = if extensions.is_empty() {
                quote! {Option::<&::mainstay_spl::token_interface::ExtensionsVec>::None}
            } else {
                quote! {Option::<&::mainstay_spl::token_interface::ExtensionsVec>::Some(&vec![#(#extensions),*])}
            };

            let freeze_authority = match freeze_authority {
                Some(fa) => quote! { Option::<&mainstay_lang::prelude::Pubkey>::Some(&#fa.key()) },
                None => quote! { Option::<&mainstay_lang::prelude::Pubkey>::None },
            };

            let group_pointer_authority = match group_pointer_authority {
                Some(gpa) => quote! { Option::<mainstay_lang::prelude::Pubkey>::Some(#gpa.key()) },
                None => quote! { Option::<mainstay_lang::prelude::Pubkey>::None },
            };
            ...
            let group_member_pointer_member_address = match group_member_pointer_member_address {
                Some(gmpma) => {
                    quote! { Option::<mainstay_lang::prelude::Pubkey>::Some(#gmpma.key()) }
                }
                None => quote! { Option::<mainstay_lang::prelude::Pubkey>::None },
            };

            let metadata_pointer_authority = match metadata_pointer_authority {
                Some(mpa) => quote! { Option::<mainstay_lang::prelude::Pubkey>::Some(#mpa.key()) },
                None => quote! { Option::<mainstay_lang::prelude::Pubkey>::None },
            };
            ...
            let close_authority = match close_authority {
                Some(ca) => quote! { Option::<&mainstay_lang::prelude::Pubkey>::Some(&#ca.key()) },
                None => quote! { Option::<&mainstay_lang::prelude::Pubkey>::None },
            };

            let permanent_delegate = match permanent_delegate {
                Some(pd) => quote! { Option::<&mainstay_lang::prelude::Pubkey>::Some(&#pd.key()) },
                None => quote! { Option::<&mainstay_lang::prelude::Pubkey>::None },
            };

            let transfer_hook_authority = match transfer_hook_authority {
                Some(tha) => quote! { Option::<mainstay_lang::prelude::Pubkey>::Some(#tha.key()) },
                None => quote! { Option::<mainstay_lang::prelude::Pubkey>::None },
            };

            let transfer_hook_program_id = match transfer_hook_program_id {
                Some(thpid) => {
                    quote! { Option::<mainstay_lang::prelude::Pubkey>::Some(#thpid.key()) }
                }
                None => quote! { Option::<mainstay_lang::prelude::Pubkey>::None },
            };
                ...
                let #field: #ty_decl = {
                    ...
                    if !#if_needed || owner_program == &mainstay_lang::solana_program::system_program::ID {
                        ...
                        if let Some(extensions) = #extensions {
                            for e in extensions {
                                match e {
                                    ::mainstay_spl::token_interface::spl_token_2022::extension::ExtensionType::GroupPointer => {
                                        ::mainstay_spl::token_interface::group_pointer_initialize(mainstay_lang::context::CpiContext::new(#token_program.to_account_info(), ::mainstay_spl::token_interface::GroupPointerInitialize {
                                            token_program_id: #token_program.to_account_info(),
                                            mint: #field.to_account_info(),
                                        }), #group_pointer_authority, #group_pointer_group_address)?;
                                    },
                                    ::mainstay_spl::token_interface::spl_token_2022::extension::ExtensionType::GroupMemberPointer => {
                                        ::mainstay_spl::token_interface::group_member_pointer_initialize(mainstay_lang::context::CpiContext::new(#token_program.to_account_info(), ::mainstay_spl::token_interface::GroupMemberPointerInitialize {
                                            token_program_id: #token_program.to_account_info(),
                                            mint: #field.to_account_info(),
                                        }), #group_member_pointer_authority, #group_member_pointer_member_address)?;
                                    },
                                    ::mainstay_spl::token_interface::spl_token_2022::extension::ExtensionType::MetadataPointer => {
                                        ::mainstay_spl::token_interface::metadata_pointer_initialize(mainstay_lang::context::CpiContext::new(#token_program.to_account_info(), ::mainstay_spl::token_interface::MetadataPointerInitialize {
                                            token_program_id: #token_program.to_account_info(),
                                            mint: #field.to_account_info(),
                                        }), #metadata_pointer_authority, #metadata_pointer_metadata_address)?;
                                    },
                                    ::mainstay_spl::token_interface::spl_token_2022::extension::ExtensionType::MintCloseAuthority => {
                                        ::mainstay_spl::token_interface::mint_close_authority_initialize(mainstay_lang::context::CpiContext::new(#token_program.to_account_info(), ::mainstay_spl::token_interface::MintCloseAuthorityInitialize {
                                            token_program_id: #token_program.to_account_info(),
                                            mint: #field.to_account_info(),
                                        }), #close_authority)?;
                                    },
                                    ::mainstay_spl::token_interface::spl_token_2022::extension::ExtensionType::TransferHook => {
                                        ::mainstay_spl::token_interface::transfer_hook_initialize(mainstay_lang::context::CpiContext::new(#token_program.to_account_info(), ::mainstay_spl::token_interface::TransferHookInitialize {
                                            token_program_id: #token_program.to_account_info(),
                                            mint: #field.to_account_info(),
                                        }), #transfer_hook_authority, #transfer_hook_program_id)?;
                                    },
                                    ::mainstay_spl::token_interface::spl_token_2022::extension::ExtensionType::NonTransferable => {
                                        ::mainstay_spl::token_interface::non_transferable_mint_initialize(mainstay_lang::context::CpiContext::new(#token_program.to_account_info(), ::mainstay_spl::token_interface::NonTransferableMintInitialize {
                                            token_program_id: #token_program.to_account_info(),
                                            mint: #field.to_account_info(),
                                        }))?;
                                    },
                                    ::mainstay_spl::token_interface::spl_token_2022::extension::ExtensionType::PermanentDelegate => {
                                        ::mainstay_spl::token_interface::permanent_delegate_initialize(mainstay_lang::context::CpiContext::new(#token_program.to_account_info(), ::mainstay_spl::token_interface::PermanentDelegateInitialize {
                                            token_program_id: #token_program.to_account_info(),
                                            mint: #field.to_account_info(),
                        ...
                        let cpi_program = #token_program.to_account_info();
                        let accounts = ::mainstay_spl::token_interface::InitializeMint2 {
                            mint: #field.to_account_info(),
                        };
                        let cpi_ctx = mainstay_lang::context::CpiContext::new(cpi_program, accounts);
                        ::mainstay_spl::token_interface::initialize_mint2(cpi_ctx, #decimals, &#owner.key(), #freeze_authority)?;
                    }

                    let pa: #ty_decl = #from_account_info_unchecked;
                    if #if_needed {
                        if pa.mint_authority != mainstay_lang::solana_program::program_option::COption::Some(#owner.key()) {
                            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintMintMintAuthority).with_account_name(#name_str));
                        }
                        if pa.freeze_authority
                            ...
                            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintMintFreezeAuthority).with_account_name(#name_str));
                        }
                        if pa.decimals != #decimals {
                            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintMintDecimals).with_account_name(#name_str).with_values((pa.decimals, #decimals)));
                        }
                        if owner_program != &#token_program.key() {
                            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintMintTokenProgram).with_account_name(#name_str).with_pubkeys((*owner_program, #token_program.key())));
                        }
                    }
                    pa
                };
        ...
        InitKind::Program { owner } | InitKind::Interface { owner } => {
            ...
            quote! {
                ...
                let #field = {
                    ...
                    let pa: #ty_decl = if !#if_needed || actual_owner == &mainstay_lang::solana_program::system_program::ID {
                        #payer_optional_check
                    ...
                    if #if_needed {
                        ...
                        if space != actual_field.data_len() {
                            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintSpace).with_account_name(#name_str).with_values((space, actual_field.data_len())));
                        }

                        if actual_owner != #owner {
                            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintOwner).with_account_name(#name_str).with_pubkeys((*actual_owner, *#owner)));
                        }

                        {
                            let required_lamports = __mainstay_rent.minimum_balance(space);
        ...
        let define_pda = match c.bump.as_ref() {
            ...
            Some(b) => quote! {
                let __pda_address = Pubkey::create_program_address(
                    ...
                    &#deriving_program_id,
                ).map_err(|_| mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintSeeds).with_account_name(#name_str))?;
            },
        };
        quote! {
            // Define the PDA.
            ...
            if #name.key() != __pda_address {
                return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintSeeds).with_account_name(#name_str).with_pubkeys((#name.key(), __pda_address)));
            }
        }
    }
}
...
fn generate_constraint_associated_token(
    ...
    let token_program_check = match &c.token_program {
        Some(token_program) => {
            ...
            quote! {
                #token_program_optional_check
                if #account_ref.owner != &#token_program.key() { return Err(mainstay_lang::error::ErrorCode::ConstraintAssociatedTokenTokenProgram.into()); }
            }
        }
        None => quote! {},
    };
    let get_associated_token_address = match &c.token_program {
        Some(token_program) => quote! {
            ::mainstay_spl::associated_token::get_associated_token_address_with_program_id(&wallet_address, &#spl_token_mint_address.key(), &#token_program.key())
        },
        None => quote! {
            ::mainstay_spl::associated_token::get_associated_token_address(&wallet_address, &#spl_token_mint_address.key())
        },
    };
    ...
    quote! {
        {
            ...
            if my_owner != wallet_address {
                return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintTokenOwner).with_account_name(#name_str).with_pubkeys((my_owner, wallet_address)));
            }
            let __associated_token_address = #get_associated_token_address;
            let my_key = #name.key();
            if my_key != __associated_token_address {
                return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintAssociated).with_account_name(#name_str).with_pubkeys((my_key, __associated_token_address)));
            }
        }
    }
}
...
fn generate_constraint_token_account(
    ...
    let authority_check = match &c.authority {
        Some(authority) => {
            ...
            quote! {
                ...
                if #name.owner != #authority.key() { return Err(mainstay_lang::error::ErrorCode::ConstraintTokenOwner.into()); }
            }
        }
        None => quote! {},
    };
    let mint_check = match &c.mint {
        Some(mint) => {
            ...
            quote! {
                #mint_optional_check
                if #name.mint != #mint.key() { return Err(mainstay_lang::error::ErrorCode::ConstraintTokenMint.into()); }
            }
        }
        None => quote! {},
    };
    let token_program_check = match &c.token_program {
        Some(token_program) => {
            ...
            quote! {
                #token_program_optional_check
                if #account_ref.owner != &#token_program.key() { return Err(mainstay_lang::error::ErrorCode::ConstraintTokenTokenProgram.into()); }
            }
        }
        None => quote! {},
    };
...
fn generate_constraint_mint(
    ...
    let decimal_check = match &c.decimals {
        Some(decimals) => quote! {
            if #name.decimals != #decimals {
                return Err(mainstay_lang::error::ErrorCode::ConstraintMintDecimals.into());
            }
        },
        None => quote! {},
    };
    ...
    let mint_authority_check = match &c.mint_authority {
        Some(mint_authority) => {
            ...
            quote! {
                ...
                if #name.mint_authority != mainstay_lang::solana_program::program_option::COption::Some(#mint_authority.key()) {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintMintAuthority.into());
                }
            }
        }
        None => quote! {},
    ...
    let freeze_authority_check = match &c.freeze_authority {
        Some(freeze_authority) => {
            ...
            quote! {
                #freeze_authority_optional_check
                if #name.freeze_authority != mainstay_lang::solana_program::program_option::COption::Some(#freeze_authority.key()) {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintFreezeAuthority.into());
                }
            }
        }
        None => quote! {},
    ...
    let token_program_check = match &c.token_program {
        Some(token_program) => {
            ...
            quote! {
                #token_program_optional_check
                if #account_ref.owner != &#token_program.key() { return Err(mainstay_lang::error::ErrorCode::ConstraintMintTokenProgram.into()); }
            }
        }
        None => quote! {},
    };
    ...
    let group_pointer_authority_check = match &c.group_pointer_authority {
        Some(group_pointer_authority) => {
            ...
            quote! {
                let group_pointer = ::mainstay_spl::token_interface::get_mint_extension_data::<::mainstay_spl::token_interface::spl_token_2022::extension::group_pointer::GroupPointer>(#account_ref);
                if group_pointer.is_err() {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintGroupPointerExtension.into());
                }
                #group_pointer_authority_optional_check
                if group_pointer.unwrap().authority != ::mainstay_spl::token_2022_extensions::spl_pod::optional_keys::OptionalNonZeroPubkey::try_from(Some(#group_pointer_authority.key()))? {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintGroupPointerExtensionAuthority.into());
                }
            }
        }
        None => quote! {},
    ...
    let group_pointer_group_address_check = match &c.group_pointer_group_address {
        Some(group_pointer_group_address) => {
            ...
            quote! {
                ...
                if group_pointer.unwrap().group_address != ::mainstay_spl::token_2022_extensions::spl_pod::optional_keys::OptionalNonZeroPubkey::try_from(Some(#group_pointer_group_address.key()))? {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintGroupPointerExtensionGroupAddress.into());
                }
            }
        }
        None => quote! {},
    ...
    let group_member_pointer_authority_check = match &c.group_member_pointer_authority {
        Some(group_member_pointer_authority) => {
            ...
            quote! {
                let group_member_pointer = ::mainstay_spl::token_interface::get_mint_extension_data::<::mainstay_spl::token_interface::spl_token_2022::extension::group_member_pointer::GroupMemberPointer>(#account_ref);
                if group_member_pointer.is_err() {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintGroupMemberPointerExtension.into());
                }
                #group_member_pointer_authority_optional_check
                if group_member_pointer.unwrap().authority != ::mainstay_spl::token_2022_extensions::spl_pod::optional_keys::OptionalNonZeroPubkey::try_from(Some(#group_member_pointer_authority.key()))? {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintGroupMemberPointerExtensionAuthority.into());
                }
            }
        }
        None => quote! {},
    ...
    let group_member_pointer_member_address_check = match &c.group_member_pointer_member_address {
        Some(group_member_pointer_member_address) => {
            ...
            quote! {
                ...
                if group_member_pointer.unwrap().member_address != ::mainstay_spl::token_2022_extensions::spl_pod::optional_keys::OptionalNonZeroPubkey::try_from(Some(#group_member_pointer_member_address.key()))? {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintGroupMemberPointerExtensionMemberAddress.into());
                }
            }
        }
        None => quote! {},
    ...
    let metadata_pointer_authority_check = match &c.metadata_pointer_authority {
        Some(metadata_pointer_authority) => {
            ...
            quote! {
                let metadata_pointer = ::mainstay_spl::token_interface::get_mint_extension_data::<::mainstay_spl::token_interface::spl_token_2022::extension::metadata_pointer::MetadataPointer>(#account_ref);
                if metadata_pointer.is_err() {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintMetadataPointerExtension.into());
                }
                #metadata_pointer_authority_optional_check
                if metadata_pointer.unwrap().authority != ::mainstay_spl::token_2022_extensions::spl_pod::optional_keys::OptionalNonZeroPubkey::try_from(Some(#metadata_pointer_authority.key()))? {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintMetadataPointerExtensionAuthority.into());
                }
            }
        }
        None => quote! {},
    ...
    let metadata_pointer_metadata_address_check = match &c.metadata_pointer_metadata_address {
        Some(metadata_pointer_metadata_address) => {
            ...
            quote! {
                ...
                if metadata_pointer.unwrap().metadata_address != ::mainstay_spl::token_2022_extensions::spl_pod::optional_keys::OptionalNonZeroPubkey::try_from(Some(#metadata_pointer_metadata_address.key()))? {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintMetadataPointerExtensionMetadataAddress.into());
                }
            }
        }
        None => quote! {},
    ...
    let close_authority_check = match &c.close_authority {
        Some(close_authority) => {
            ...
            quote! {
                let close_authority = ::mainstay_spl::token_interface::get_mint_extension_data::<::mainstay_spl::token_interface::spl_token_2022::extension::mint_close_authority::MintCloseAuthority>(#account_ref);
                if close_authority.is_err() {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintCloseAuthorityExtension.into());
                }
                #close_authority_optional_check
                if close_authority.unwrap().close_authority != ::mainstay_spl::token_2022_extensions::spl_pod::optional_keys::OptionalNonZeroPubkey::try_from(Some(#close_authority.key()))? {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintCloseAuthorityExtensionAuthority.into());
                }
            }
        }
        None => quote! {},
    ...
    let permanent_delegate_check = match &c.permanent_delegate {
        Some(permanent_delegate) => {
            ...
            quote! {
                let permanent_delegate = ::mainstay_spl::token_interface::get_mint_extension_data::<::mainstay_spl::token_interface::spl_token_2022::extension::permanent_delegate::PermanentDelegate>(#account_ref);
                if permanent_delegate.is_err() {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintPermanentDelegateExtension.into());
                }
                #permanent_delegate_optional_check
                if permanent_delegate.unwrap().delegate != ::mainstay_spl::token_2022_extensions::spl_pod::optional_keys::OptionalNonZeroPubkey::try_from(Some(#permanent_delegate.key()))? {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintPermanentDelegateExtensionDelegate.into());
                }
            }
        }
        None => quote! {},
    ...
    let transfer_hook_authority_check = match &c.transfer_hook_authority {
        Some(transfer_hook_authority) => {
            ...
            quote! {
                let transfer_hook = ::mainstay_spl::token_interface::get_mint_extension_data::<::mainstay_spl::token_interface::spl_token_2022::extension::transfer_hook::TransferHook>(#account_ref);
                if transfer_hook.is_err() {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintTransferHookExtension.into());
                }
                #transfer_hook_authority_optional_check
                if transfer_hook.unwrap().authority != ::mainstay_spl::token_2022_extensions::spl_pod::optional_keys::OptionalNonZeroPubkey::try_from(Some(#transfer_hook_authority.key()))? {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintTransferHookExtensionAuthority.into());
                }
            }
        }
        None => quote! {},
    ...
    let transfer_hook_program_id_check = match &c.transfer_hook_program_id {
        Some(transfer_hook_program_id) => {
            ...
            quote! {
                ...
                if transfer_hook.unwrap().program_id != ::mainstay_spl::token_2022_extensions::spl_pod::optional_keys::OptionalNonZeroPubkey::try_from(Some(#transfer_hook_program_id.key()))? {
                    return Err(mainstay_lang::error::ErrorCode::ConstraintMintTransferHookExtensionProgramId.into());
                }
            }
        }
        None => quote! {},
            ...
            if self.accounts.is_field_optional(&field) {
                quote! {
                    let #field = if let Some(ref account) = #field {
                        ...
                        return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintAccountIsNone).with_account_name(#field_name));
                    };
                }
            } else {
                quote! {}
    ...
    quote! {
        {
            ...
            if *mint_info.owner == ::mainstay_spl::token_2022::Token2022::id() {
                use ::mainstay_spl::token_2022::spl_token_2022::extension::{BaseStateWithExtensions, ExtensionType, StateWithExtensions};
                use ::mainstay_spl::token_2022::spl_token_2022::state::{Account, Mint};
                ...
                ::mainstay_spl::token::TokenAccount::LEN
            }
        }
    }
}
...
fn generate_create_account(
    ...
    quote! {
        ...
        if __current_lamports == 0 {
            ...
            let space = #space;
            let lamports = __mainstay_rent.minimum_balance(space);
            let cpi_accounts = mainstay_lang::system_program::CreateAccount {
                from: #payer.to_account_info(),
                to: #field.to_account_info()
            };
            let cpi_context = mainstay_lang::context::CpiContext::new(system_program.to_account_info(), cpi_accounts);
            mainstay_lang::system_program::create_account(cpi_context.with_signer(&[#seeds_with_nonce]), lamports, space as u64, #owner)?;
        } else {
            require_keys_neq!(#payer.key(), #field.key(), mainstay_lang::error::ErrorCode::TryingToInitPayerAsProgramAccount);
            // Fund the account for rent exemption.
            let required_lamports = __mainstay_rent
                .minimum_balance(#space)
                .max(1)
                .saturating_sub(__current_lamports);
            if required_lamports > 0 {
                let cpi_accounts = mainstay_lang::system_program::Transfer {
                    from: #payer.to_account_info(),
                    to: #field.to_account_info(),
                };
                let cpi_context = mainstay_lang::context::CpiContext::new(system_program.to_account_info(), cpi_accounts);
                mainstay_lang::system_program::transfer(cpi_context, required_lamports)?;
            }
            // Allocate space.
            let cpi_accounts = mainstay_lang::system_program::Allocate {
                account_to_allocate: #field.to_account_info()
            };
            let cpi_context = mainstay_lang::context::CpiContext::new(system_program.to_account_info(), cpi_accounts);
            mainstay_lang::system_program::allocate(cpi_context.with_signer(&[#seeds_with_nonce]), #space as u64)?;
            // Assign to the spl token program.
            let cpi_accounts = mainstay_lang::system_program::Assign {
                account_to_assign: #field.to_account_info()
            };
            let cpi_context = mainstay_lang::context::CpiContext::new(system_program.to_account_info(), cpi_accounts);
            mainstay_lang::system_program::assign(cpi_context.with_signer(&[#seeds_with_nonce]), #owner)?;
        }
    }
}
...
pub fn generate_constraint_executable(
    ...
    quote! {
        if !#account_ref.executable {
            return Err(mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::ConstraintExecutable).with_account_name(#name_str));
        }
    }
}
...
fn generate_custom_error(
    ...
    let mut error = match custom_error {
        Some(error) => {
            quote! { mainstay_lang::error::Error::from(#error).with_account_name(#account_name) }
        }
        None => {
            quote! { mainstay_lang::error::Error::from(mainstay_lang::error::ErrorCode::#error).with_account_name(#account_name) }
        }
    };
