...
pub fn generate(accs: &AccountsStruct) -> proc_macro2::TokenStream {
            ...
            match af {
                AccountField::CompositeField(s) => {
                    ...
                    quote! {
                        ...
                        let #name: #ty = mainstay_lang::Accounts::try_accounts(__program_id, __accounts, __ix_data, &mut __bumps.#name, __reallocs)?;
                    }
                }
                    ...
                    if is_init(af) || f.constraints.zeroed.is_some()  {
                        ...
                        if f.is_optional {
                            ...
                            let empty_behavior = if cfg!(feature = "allow-missing-optionals") {
                                ...
                                quote!{ return Err(mainstay_lang::error::ErrorCode::AccountNotEnoughKeys.into()); }
                            };
                            quote! {
                            ...
                            quote!{
                                if __accounts.is_empty() {
                                    return Err(mainstay_lang::error::ErrorCode::AccountNotEnoughKeys.into());
                                }
                        ...
                        quote! {
                            ...
                            let #typed_name = mainstay_lang::Accounts::try_accounts(__program_id, __accounts, __ix_data, __bumps, __reallocs)
    ...
    let ix_de = match &accs.instruction_api {
        ...
        Some(ix_api) => {
            ...
            quote! {
                ...
                #[derive(mainstay_lang::MainstaySerialize, mainstay_lang::MainstayDeserialize)]
                struct __Args {
                    #strct_inner
                }
                let __Args {
    ...
    quote! {
        ...
        impl<#combined_generics> mainstay_lang::Accounts<#trait_generics, #bumps_struct_name> for #name<#struct_generics> #where_clause {
            #[inline(never)]
            fn try_accounts(
                __program_id: &mainstay_lang::solana_program::pubkey::Pubkey,
                __accounts: &mut &#trait_generics [mainstay_lang::solana_program::account_info::AccountInfo<#trait_generics>],
                __ix_data: &[u8],
                __bumps: &mut #bumps_struct_name,
                __reallocs: &mut std::collections::BTreeSet<mainstay_lang::solana_program::pubkey::Pubkey>,
            ) -> mainstay_lang::Result<Self> {
