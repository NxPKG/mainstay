...
pub fn generate(program: &Program) -> proc_macro2::TokenStream {
    ...
    let event_cpi_handler = {
        ...
        quote! {
            ...
            __private::__events::__event_dispatch(
                program_id,
                accounts,
                &data[mainstay_lang::event::EVENT_IX_TAG_LE.len()..]
            )
        }
    ...
    quote! {
        ...
        fn dispatch<'info>(
            ...
            if data.starts_with(mainstay_lang::idl::IDL_IX_TAG_LE) {
                ...
                return __private::__idl::__idl_dispatch(
                    program_id,
                    accounts,
                    &data[mainstay_lang::idl::IDL_IX_TAG_LE.len()..],
                );
                #[cfg(feature = "no-idl")]
                return Err(mainstay_lang::error::ErrorCode::IdlInstructionStub.into());
            }

            // Dispatch Event CPI instruction
            if data.starts_with(mainstay_lang::event::EVENT_IX_TAG_LE) {
