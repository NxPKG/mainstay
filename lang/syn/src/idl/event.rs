...
pub fn gen_idl_print_fn_event(event_struct: &syn::ItemStruct) -> TokenStream {
    ...
    let fn_name = format_ident!(
        "__mainstay_private_print_idl_event_{}",
    ...
    quote! {
        ...
        pub fn #fn_name() {
            ...
            if let Some(event) = #ident::__mainstay_private_gen_idl_event(&mut types) {
                #print_ts
            }
        }
    }
...
fn impl_idl_build_event(event_struct: &syn::ItemStruct) -> TokenStream {
    ...
    let fn_body = match gen_idl_type_def_struct(event_struct) {
        Ok((ts, defined)) => quote! {
            ...
            let event = #idl::IdlEvent {
                name: ty.name.clone(),
                discriminator: <Self as mainstay_lang::Discriminator>::DISCRIMINATOR.into(),
            };
    ...
    quote! {
        impl #impl_generics #ident #ty_generics #where_clause {
            pub fn __mainstay_private_gen_idl_event(
