use crate::{MainstayDeserialize, Pubkey};
...
///
/// It's currently implemented automatically if you derive [`MainstayDeserialize`]:
///
/// ```ignore
/// #[derive(MainstayDeserialize)]
/// pub struct MyStruct {
///     field: u8,
/// }
/// ```
pub trait Lazy: MainstayDeserialize {
