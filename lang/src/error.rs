...
pub enum Error {
    MainstayError(Box<MainstayError>),
...
impl Display for Error {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            Error::MainstayError(ae) => Display::fmt(&ae, f),
            Error::ProgramError(pe) => Display::fmt(&pe, f),
        }
    }
}

impl From<MainstayError> for Error {
    fn from(ae: MainstayError) -> Self {
        Self::MainstayError(Box::new(ae))
    }
}
...
impl From<TryFromIntError> for Error {
    fn from(e: TryFromIntError) -> Self {
        Self::MainstayError(Box::new(MainstayError {
...
impl Error {
    pub fn log(&self) {
        match self {
            ...
            Error::MainstayError(mainstay_error) => mainstay_error.log(),
        }
    }

    pub fn with_account_name(mut self, account_name: impl ToString) -> Self {
        match &mut self {
            Error::MainstayError(ae) => {
    ...
    pub fn with_pubkeys(mut self, pubkeys: (Pubkey, Pubkey)) -> Self {
        ...
        match &mut self {
            Error::MainstayError(ae) => ae.compared_values = pubkeys,
...
impl ProgramErrorWithOrigin {
    pub fn log(&self) {
        match &self.error_origin {
            None => {
                mainstay_lang::solana_program::msg!(
            ...
            Some(ErrorOrigin::AccountName(account_name)) => {
                ...
                mainstay_lang::solana_program::log::sol_log(&format!(
        ...
        match &self.compared_values {
            Some(ComparedValues::Pubkeys((left, right))) => {
                mainstay_lang::solana_program::msg!("Left:");
                left.log();
                mainstay_lang::solana_program::msg!("Right:");
                right.log();
            }
            Some(ComparedValues::Values((left, right))) => {
                mainstay_lang::solana_program::msg!("Left: {}", left);
                mainstay_lang::solana_program::msg!("Right: {}", right);
            }
            None => (),
        }
    }
...
impl MainstayError {
    pub fn log(&self) {
        match &self.error_origin {
            None => {
                mainstay_lang::solana_program::log::sol_log(&format!(
                    "MainstayError occurred. Error Code: {}. Error Number: {}. Error Message: {}.",
                    self.error_name, self.error_code_number, self.error_msg
                ));
            }
            Some(ErrorOrigin::Source(source)) => {
                mainstay_lang::solana_program::msg!(
                    "MainstayError thrown in {}:{}. Error Code: {}. Error Number: {}. Error Message: {}.",
                    source.filename,
                    source.line,
                    self.error_name,
            ...
            Some(ErrorOrigin::AccountName(account_name)) => {
                mainstay_lang::solana_program::log::sol_log(&format!(
                    "MainstayError caused by account: {}. Error Code: {}. Error Number: {}. Error Message: {}.",
                    account_name,
                    self.error_name,
                    self.error_code_number,
                    self.error_msg
...
impl Display for MainstayError {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        Debug::fmt(&self, f)
    }
}

/// Two `MainstayError`s are equal when they have the same error code
...
impl Eq for MainstayError {}

impl std::convert::From<Error> for mainstay_lang::solana_program::program_error::ProgramError {
    fn from(e: Error) -> mainstay_lang::solana_program::program_error::ProgramError {
        match e {
            Error::MainstayError(error) => {
                mainstay_lang::solana_program::program_error::ProgramError::Custom(
