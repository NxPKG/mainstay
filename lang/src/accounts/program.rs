...
///
/// Between the [`mainstay_lang`](https://docs.rs/mainstay-lang/latest/mainstay_lang) and [`mainstay_spl`](https://docs.rs/mainstay_spl/latest/mainstay_spl) crates,
/// the following `Program` types are provided out of the box:
///
/// - [`System`](https://docs.rs/mainstay-lang/latest/mainstay_lang/struct.System.html)
/// - [`AssociatedToken`](https://docs.rs/mainstay-spl/latest/mainstay_spl/associated_token/struct.AssociatedToken.html)
/// - [`Token`](https://docs.rs/mainstay-spl/latest/mainstay_spl/token/struct.Token.html)
///
#[derive(Clone)]
