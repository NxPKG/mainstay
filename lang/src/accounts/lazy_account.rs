...
///
/// Mainstay uses [`borsh`] deserialization by default, which can be expensive for both memory and
/// compute units usage.
///
...
/// place where Mainstay programs are likely to hit stack violation errors is a generated function
