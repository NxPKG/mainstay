...
/// - [Using InterfaceAccount with non-mainstay types](#using-interface-account-with-non-mainstay-types)
...
/// ```
///
/// # Using InterfaceAccount with non-mainstay programs
///
/// InterfaceAccount can also be used with non-mainstay programs. The data types from
...
/// ### SPL Types
///
/// Mainstay provides wrapper types to access accounts owned by the token programs. Use
/// ```ignore
/// use mainstay_spl::token_interface::TokenAccount;
///
/// #[derive(Accounts)]
/// pub struct Example {
...
/// ```ignore
/// use mainstay_spl::token_interface::Mint;
///
/// #[derive(Accounts)]
/// pub struct Example {
