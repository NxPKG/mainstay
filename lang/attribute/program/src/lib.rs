...
pub fn program(
    ...
    parse_macro_input!(input as mainstay_syn::Program)
        .to_token_stream()
        .into()
}
...
/// depth, e.g. both inside the program's directory (`<PROGRAM_DIR>/idls`) and inside Mainstay
...
///
/// [here]: https://github.com/nxpkg/mainstay/tree/v0.30.1/tests/declare-program
#[proc_macro]
...
#[deprecated(
    ...
    See examples in https://github.com/nxpkg/mainstay/tree/v0.31.0/tests/spl/transfer-hook"
)]
#[proc_macro_attribute]
pub fn interface(
    _args: proc_macro::TokenStream,
