...
/// ```ignore
/// ...
/// pub fn initialize(ctx: Context<Create>, bump: u8, authority: Pubkey, data: u64) -> mainstay_lang::Result<()> {
///     ...
///     Ok(())
/// }
/// ...
...
///                 Makes mainstay persist any state changes.<br>
...
///                         for accounts owned by mainstay programs.<br>
...
///                         Check out the <a href = "https://www.mainstay-lang.com/docs/space" target = "_blank" rel = "noopener noreferrer">space reference</a>
///                         and the <a href = "https://borsh.io/" target = "_blank" rel = "noopener noreferrer">borsh library</a>
///                         (which mainstay uses under the hood for serialization) specification to learn how much
...
///                         Mainstay will then check that the bump returned by <code>find_program_address</code> equals
...
///                 You can enable it by importing <code>mainstay-lang</code> with the <code>init-if-needed</code> cargo feature.<br>
...
///                 the seeds, and if provided, the bump. If not provided, mainstay uses the canonical
///                 bump. <br>
...
///                 Mainstay adds internal data to the account when using <code>zero</code> just like it
...
/// # SPL Constraints
///
/// Mainstay provides constraints that make verifying SPL accounts easier.
///
/// <table>
///     <thead>
///         <tr>
...
///                 Example:
///                 <pre>
/// use mainstay_spl::{mint, token::{TokenAccount, Mint, Token}};
/// ...&#10;
/// #[account(
///     init,
///     payer = payer,
...
///                 Example:
///                 <pre>
/// use mainstay_spl::token::{Mint, Token};
/// ...&#10;
/// #[account(
///     init,
///     payer = payer,
...
///                 Example:
///                 <pre>
/// use mainstay_spl::token_interface::{TokenInterface, TokenAccount, Mint};
/// ...&#10;
/// #[account(
...
pub fn derive_accounts(item: TokenStream) -> TokenStream {
    parse_macro_input!(item as mainstay_syn::AccountsStruct)
        .to_token_stream()
        .into()
}
