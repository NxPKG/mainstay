...
#[proc_macro_derive(MainstaySerialize, attributes(borsh_skip))]
pub fn mainstay_serialize(input: TokenStream) -> TokenStream {
...
#[proc_macro_derive(MainstayDeserialize, attributes(borsh_skip, borsh_init))]
