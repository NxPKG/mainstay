...
mod id {
    mainstay_lang::declare_id!("Fg6PaFpoGXkYsidMpWTK6W2BeZ7FEfcYkg476zPFsLnS");
}
...
mod pk {
    pub(super) const PUBKEY: mainstay_lang::solana_program::pubkey::Pubkey =
        mainstay_lang::pubkey!("A7yUYJNEVYRLE4QWsnc9rE9JRsm7DfqEmLscQVwkffAk");
}
