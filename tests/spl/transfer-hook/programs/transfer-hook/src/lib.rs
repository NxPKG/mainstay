...
pub mod transfer_hook {
    ...
    pub fn initialize(ctx: Context<Initialize>, metas: Vec<MainstayExtraAccountMeta>) -> Result<()> {
...
#[derive(Accounts)]
#[instruction(metas: Vec<MainstayExtraAccountMeta>)]
...
pub struct MainstayExtraAccountMeta {
    pub discriminator: u8,
    pub address_config: [u8; 32],
    pub is_signer: bool,
    pub is_writable: bool,
}
impl From<MainstayExtraAccountMeta> for ExtraAccountMeta {
    fn from(meta: MainstayExtraAccountMeta) -> Self {
        Self {
