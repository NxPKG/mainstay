...
import { Program, MainstayError } from "@nx-pkg/mainstay";
...
const withLogTest = async (callback, expectedLogs) => {
  let logTestOk = false;
  const listener = mainstay.getProvider().connection.onLogs(
    "all",
    (logs) => {
  ...
  try {
    ...
    mainstay.getProvider().connection.removeOnLogsListener(listener);
    throw err;
  }
  mainstay.getProvider().connection.removeOnLogsListener(listener);
...
describe("errors", () => {
  ...
  // processed failed tx do not result in MainstayErrors in the client
  // because we cannot get logs for them (only through overkill `onLogs`)
  provider.opts.commitment = "confirmed";
  mainstay.setProvider(provider);

  const program = mainstay.workspace.Errors as Program<Errors>;
  ...
  it("Emits a Hello error", async () => {
    await withLogTest(async () => {
      try {
        ...
        const fullErrMsg =
          "MainstayError thrown in programs/errors/src/lib.rs:13. Error Code: Hello. Error Number: 6000. Error Message: This is an error message clients will automatically display.";
      ...
      "Program log: MainstayError thrown in programs/errors/src/lib.rs:13. Error Code: Hello. Error Number: 6000. Error Message: This is an error message clients will automatically display.",
    ]);
  });
    ...
    await withLogTest(async () => {
      try {
        const tx = await program.rpc.mutError({
          accounts: {
            myAccount: mainstay.web3.SYSVAR_RENT_PUBKEY,
          },
        });
        assert.ok(false);
      } catch (_err) {
      ...
      "Program log: MainstayError caused by account: my_account. Error Code: ConstraintMut. Error Number: 2000. Error Message: A mut constraint was violated.",
    ]);
  });
  ...
  it("Emits a has one error", async () => {
    await withLogTest(async () => {
      try {
        ...
        const tx = await program.rpc.hasOneError({
          accounts: {
            ...
            owner: mainstay.web3.SYSVAR_RENT_PUBKEY,
          },
      ...
      "Program log: MainstayError caused by account: my_account. Error Code: ConstraintHasOne. Error Number: 2001. Error Message: A has one constraint was violated.",
      "Program log: Left:",
    ...
    try {
      ...
      tx.add(
        new TransactionInstruction({
          keys: [
            {
              pubkey: mainstay.web3.SYSVAR_RENT_PUBKEY,
              isWritable: false,
              isSigner: false,
            },
          ],
    ...
    await withLogTest(async () => {
      try {
        const tx = await program.rpc.accountNotInitializedError({
          accounts: {
            notInitializedAccount: new mainstay.web3.Keypair().publicKey,
          },
        });
        assert.fail(
      ...
      "Program log: MainstayError caused by account: not_initialized_account. Error Code: AccountNotInitialized. Error Number: 3012. Error Message: The program expected this account to be already initialized.",
    ]);
  });
  ...
  it("Emits an AccountOwnedByWrongProgram error", async () => {
    let client = await Token.createMint(
      ...
      (provider.wallet as mainstay.Wallet).payer,
    ...
    await withLogTest(async () => {
      ...
      "Program log: MainstayError caused by account: wrong_account. Error Code: AccountOwnedByWrongProgram. Error Number: 3007. Error Message: The given account is owned by a different program than expected.",
      "Program log: Left:",
  ...
  it("Emits a ValueMismatch error via require_eq", async () => {
    await withLogTest(async () => {
      ...
      "Program log: MainstayError thrown in programs/errors/src/lib.rs:68. Error Code: ValueMismatch. Error Number: 6126. Error Message: ValueMismatch.",
  ...
  it("Emits a RequireEqViolated error via require_eq", async () => {
    await withLogTest(async () => {
      ...
      "Program log: MainstayError thrown in programs/errors/src/lib.rs:73. Error Code: RequireEqViolated. Error Number: 2501. Error Message: A require_eq expression was violated.",
      "Program log: Left: 5241",
      "Program log: Right: 124124124",
    ]);
  });
  ...
  it("Emits a ValueMatch error via require_neq", async () => {
    await withLogTest(async () => {
      ...
      "Program log: MainstayError thrown in programs/errors/src/lib.rs:78. Error Code: ValueMatch. Error Number: 6127. Error Message: ValueMatch.",
  ...
  it("Emits a RequireNeqViolated error via require_neq", async () => {
    await withLogTest(async () => {
      ...
      "Program log: MainstayError thrown in programs/errors/src/lib.rs:83. Error Code: RequireNeqViolated. Error Number: 2503. Error Message: A require_neq expression was violated.",
      "Program log: Left: 500",
      "Program log: Right: 500",
    ]);
  });
  ...
  it("Emits a ValueMismatch error via require_keys_eq", async () => {
    const someAccount = mainstay.web3.Keypair.generate().publicKey;
    await withLogTest(async () => {
      try {
      ...
      "Program log: MainstayError thrown in programs/errors/src/lib.rs:88. Error Code: ValueMismatch. Error Number: 6126. Error Message: ValueMismatch.",
      "Program log: Left:",
  ...
  it("Emits a RequireKeysEqViolated error via require_keys_eq", async () => {
    ...
    await withLogTest(async () => {
      ...
      "Program log: MainstayError thrown in programs/errors/src/lib.rs:97. Error Code: RequireKeysEqViolated. Error Number: 2502. Error Message: A require_keys_eq expression was violated.",
      "Program log: Left:",
      `Program log: ${someAccount}`,
      "Program log: Right:",
      `Program log: ${program.programId}`,
  ...
  it("Emits a ValueMatch error via require_keys_neq", async () => {
    ...
    await withLogTest(async () => {
      ...
      "Program log: MainstayError thrown in programs/errors/src/lib.rs:102. Error Code: ValueMatch. Error Number: 6127. Error Message: ValueMatch.",
      "Program log: Left:",
      `Program log: ${someAccount}`,
      "Program log: Right:",
      `Program log: ${program.programId}`,
  ...
  it("Emits a RequireKeysNeqViolated error via require_keys_neq", async () => {
    ...
    await withLogTest(async () => {
      ...
      "Program log: MainstayError thrown in programs/errors/src/lib.rs:111. Error Code: RequireKeysNeqViolated. Error Number: 2504. Error Message: A require_keys_neq expression was violated.",
      "Program log: Left:",
      `Program log: ${someAccount}`,
      "Program log: Right:",
      `Program log: ${program.programId}`,
  ...
  it("Emits a ValueLessOrEqual error via require_gt", async () => {
    await withLogTest(async () => {
      ...
      "Program log: MainstayError thrown in programs/errors/src/lib.rs:116. Error Code: ValueLessOrEqual. Error Number: 6129. Error Message: ValueLessOrEqual.",
      "Program log: Left: 5",
  ...
  it("Emits a RequireGtViolated error via require_gt", async () => {
    await withLogTest(async () => {
      ...
      "Program log: MainstayError thrown in programs/errors/src/lib.rs:121. Error Code: RequireGtViolated. Error Number: 2505. Error Message: A require_gt expression was violated.",
      "Program log: Left: 10",
      "Program log: Right: 10",
    ]);
  });
  ...
  it("Emits a ValueLess error via require_gte", async () => {
    await withLogTest(async () => {
      ...
      "Program log: MainstayError thrown in programs/errors/src/lib.rs:126. Error Code: ValueLess. Error Number: 6128. Error Message: ValueLess.",
      "Program log: Left: 5",
      "Program log: Right: 10",
    ]);
  });
  ...
  it("Emits a RequireGteViolated error via require_gte", async () => {
    await withLogTest(async () => {
      ...
      "Program log: MainstayError thrown in programs/errors/src/lib.rs:131. Error Code: RequireGteViolated. Error Number: 2506. Error Message: A require_gte expression was violated.",
      "Program log: Left: 5",
      "Program log: Right: 10",
    ]);
  });
  ...
  it("Emits a InvalidNumericConversion error via try_into", async () => {
    await withLogTest(async () => {
      ...
      "Program log: MainstayError occurred. Error Code: InvalidNumericConversion. Error Number: 4102. Error Message: out of range integral type conversion attempted.",
    ]);
  });
});
