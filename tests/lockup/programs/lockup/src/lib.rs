//! A relatively advanced example of a lockup program. If you're new to Mainstay,
...
use mainstay_lang::solana_program::instruction::Instruction;
use mainstay_spl::token::{self, TokenAccount, Transfer};
...
#[derive(MainstaySerialize, MainstayDeserialize, PartialEq, Default, Copy, Clone)]
