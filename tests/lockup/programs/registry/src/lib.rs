//! A relatively advanced example of a staking program. If you're new to Mainstay,
//! it's suggested to start with the other examples.

use mainstay_lang::accounts::state::ProgramState;
use mainstay_lang::prelude::*;
use mainstay_lang::solana_program::account_info::next_account_info;
use mainstay_lang::solana_program::program_option::COption;
use mainstay_spl::token::{self, Mint, TokenAccount, Transfer};
...
// stake.
#[derive(MainstaySerialize, MainstayDeserialize, Default, Debug, Clone, PartialEq)]
...
#[derive(Default, Clone, Copy, Debug, MainstaySerialize, MainstayDeserialize)]
...
#[derive(MainstaySerialize, MainstayDeserialize, Clone, PartialEq)]
