...
use mainstay_spl::token::{self, Burn, CloseAccount, Mint, MintTo, Token, TokenAccount, Transfer};
...
#[derive(MainstaySerialize, MainstayDeserialize, InitSpace, Default, Clone, Copy)]
pub struct IdoTimes {
    pub start_ido: i64,    // 8
...
#[derive(MainstaySerialize, MainstayDeserialize, InitSpace, Default, Clone)]
