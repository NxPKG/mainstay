//! This program is used to measure the performance of Mainstay programs.
//!
//! If you are making a change to this program, run `mainstay run sync`.

use mainstay_lang::prelude::*;
use mainstay_spl::token_interface::{Mint, TokenAccount, TokenInterface};
