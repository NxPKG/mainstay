 ...
 * ## Program
 *
 * Program provides the IDL deserialized client representation of an Mainstay
 * program.
 *
 ...
 * [here](https://github.com/project-serum/mainstay#examples).
 */
export class Program {
   ...
   * via the mainstay CLI's `mainstay idl init` command.
   *
   * @param programId The on-chain address of the program.
